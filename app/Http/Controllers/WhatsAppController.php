...
class WhatsAppController extends Controller
{
    ...
    public function sendAppointmentConfirmation(Request $request): JsonResponse
    {
        ...
        $formattedDate = \Carbon\Carbon::parse($data["date"])
            ->locale("es")
    ...
    public function webhook(Request $request)
    {
        ...
        if ($request->isMethod("get")) {
            ...
            $verifyToken = config("services.whatsapp_service.token");
    ...
    private function handleButtonClick(string $from, string $buttonId)
    {
        switch ($buttonId) {
            ...
            default:
                $response =
                    "Gracias por tu interés. Un agente se comunicará contigo pronto.";
        }
    ...
    public function status(): JsonResponse
    {
        ...
        $qrStatus = $this->whatsappService->getQRStatus();
        ...
        return response()->json([
            ...
            "connection_info" => $connectionStatus["data"] ?? null,
            "qr_info" => $qrStatus["success"] ? $qrStatus["data"] : null,
        ]);
    }
     ...
     */
    public function requestNewQr(): JsonResponse
    {
        $result = $this->whatsappService->requestNewQR();
     ...
     */
    public function forceReconnect(): JsonResponse
    {
        $result = $this->whatsappService->forceReconnect();
     ...
     */
    public function resetAuth(): JsonResponse
    {
        $result = $this->whatsappService->resetAuth();
     ...
     */
    public function getSentMessages(): JsonResponse
    {
        $result = $this->whatsappService->getSentMessages();
